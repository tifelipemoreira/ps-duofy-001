        ...
        ElseIf cIdPonto == 'FORMPRE'
            ...
            if nOperation == 4
                If FWFldGet("Z01_STATUS") == '2'
                    ...
                    Help(NIL, NIL, OemToAnsi("Aten��o"), NIL, OemToAnsi("N�o � permitido realizar altera��es em contratos j� efetivados."), 1, 0, NIL, NIL, NIL, NIL, NIL, {""})
                    return xRet := .F.
                EndIf
            EndIf
...
User Function AtvCtr()
    ...
    If Z01->Z01_STATUS == '1'
        ...
        EndIF
    Else
        Help(NIL, NIL, OemToAnsi("N�o Permitido"), NIL, OemToAnsi("N�o � permitido realizar a efetiva��o deste contrato."), 1, 0, NIL, NIL, NIL, NIL, NIL, {OemToAnsi("Verifique o status do contrato.")})
        Return
    EndIf
    ...
    Begin Transaction
        For nX := 1 To Z01->Z01_QTDPAR
            ...
            IncProc(OemToAnsi("Inclus�o de Titulo do contrato:  ") + AllTrim(Z01->Z01_CODCTR) + " - Parcela: " + AllTrim(str(nx)) )
            ...
            If lMsErroAuto
                MostraErro()
                Help(NIL, NIL, OemToAnsi("Aten��o"), NIL, OemToAnsi("O erro informado impediu a gera��o do t�tulo."), 1, 0, NIL, NIL, NIL, NIL, NIL, {OemToAnsi("Corrija o erro.")})
